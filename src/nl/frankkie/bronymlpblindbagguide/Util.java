...
public class Util {
    ...
    public static WaveManager initWavesCSV(Context context) throws IOException {
        ...
        Wave w10b = new Wave(context, 102, waveString + " 10b", R.string.wave_10a, "covers/mlp-wave-10a-uk-blind-bag.jpg", "data/wave-10b.csv");
        ...
        wavemanager.waves = new Wave[]{w1, w2, w3, w4, w5, w6, w7, w8, w8a, w8b, w9, w9a, w9b, w10, w10a, w10b, w11, collectionSets, miniSets};
        return wavemanager;
    }
}